...
void PlanFileCopyTest() {
    Plan  plan1;
    plan1.fromFile("/Users/gevorgtsaturyan/Downloads/input.txt");
...
void PlanAddDelTest(){
    ...
    plan.fromFile("/Users/gevorgtsaturyan/Downloads/input.txt");
...
void PlanFileTest() {
    ...
    std::string t;
    plan.fromFile("/Users/gevorgtsaturyan/Downloads/input.txt");
    plan.toFile("/Users/gevorgtsaturyan/Downloads/output.txt");
    std::ifstream file("/Users/gevorgtsaturyan/Downloads/output.txt");
